...
#   parallel(n_rep=n_rep, r=i, p_dis=0.01)
# }
for(i in seq(1,3, by=0.2)) {
#   parallel(n_rep=n_rep, p_dis=0.1, r=i)
#   parallel(n_rep=n_rep, p_dis=0.2, r=i) 
  parallel(n_rep=n_rep, p_dis=0.05, r=i)
}

for(i in seq(1,3, by=0.2)) {
  #   parallel(n_rep=n_rep, p_dis=0.1, r=i)
  #   parallel(n_rep=n_rep, p_dis=0.2, r=i) 
  parallel(n_rep=n_rep, p_dis=0.01, r=i)
}
...
##submit jobs.txt via runbatch.pl
