...
opts["param"] = "--time=1-12:0 --exclude=dl3601,r05" #indicate this is a quick job
######################
...
opts["param"] = "--mem-per-cpu=4096 --time=1-12:0 --exclude=dl3601,r05" #indicate this is a quick job
